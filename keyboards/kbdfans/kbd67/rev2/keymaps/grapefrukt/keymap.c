...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |----------------------------------------------------------------|
     * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  {|  }| Ent |Vol+|
     * |------------------------------------------------------.    |----|
     * |KpEnt |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;|  '|  #|    |Vol-|
     * |----------------------------------------------------------------|
    ...
    [_QWERTY] = LAYOUT_all(
        ...
        KC_PENT,      KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT,                KC_ENT,  KC_AUDIO_VOL_UP, 
    ...
    [_FUNC] = LAYOUT_all(
         ...
         _______,   _______, _______, _______, _______, _______, _______,_______,_______,_______,_______,_______,_______,_______,   TD(TD_PAUSE_SKIP), 
         _______,     _______, _______, _______, _______, _______, _______,_______,_______,_______,_______,_______,      _______,   KC_AUDIO_MUTE , 
         _______,_______,_______, _______, _______, _______,_______,_______,_______,_______,_______,_______,_______,        KC_PGUP,KC_DEL, 
